import styles from './ModalAllergen.module.css'
...
const ModalAllergen: FC<ModalProps> = ({closeModal, dataToEdit, setDataToEdit, setAlergenos}) => {
  ...
  return (
    <div className={styles.modal}>
        ...
        <h2 className={styles.modalTitle}>{dataToEdit ? "Editar": "Añadir"} Alergeno</h2>
